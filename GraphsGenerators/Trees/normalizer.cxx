...
#include </home/federico/msc-graphstudy-master/dependencies/ogdf/include/ogdf/basic/Graph.h>
...
void normalize_layout_scale_connected(ogdf::GraphAttributes& attrs)
{
    ...
    for (const auto e : attrs.constGraph().edges) {
        ...
        //dsum += distance(p1, p2);
	dsum += sqrt((attrs.x(v1)-attrs.x(v2))*(attrs.x(v1)-attrs.x(v2))+(attrs.y(v1)-attrs.y(v2))*(attrs.y(v1)-attrs.y(v2)));
    }
